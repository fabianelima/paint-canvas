...
var drawingApp = (function () {
	...
	var contexts = {},
		...
		// Creates a canvas element, loads assets/images, adds events, and draws the canvas for the first time.
		init = function (width, height) {
			...
			bucketBackgroundImage.src = "assets/images/bucket-background.png";
